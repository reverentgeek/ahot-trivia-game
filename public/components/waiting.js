	...
	template: `<div class="container flex flex-col items-center">
		...
		<div class="my-4 border-solid border-orange-600 bg-orange-300 p-6">
			...
			<div class="flex flex-1" role="status">
				<svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-300 animate-spin dark:text-gray-600 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
